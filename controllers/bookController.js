...
exports.index = function(req, res) {
    ...
    async.parallel({
        ...
        res.render('index', { title: 'Jiahao\'s Book Inventory', error: err, data: results });
    });
};
...
exports.book_delete_post = function(req, res, next) {
    ...
    async.parallel({
        ...
        if (results.book_instances.length > 0) {
            ...
            // Book has no book instances. Delete object and redirect to the list of genres.
            //console.log("deleting genre now ")
